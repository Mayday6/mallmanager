...
<div class="grid-content bg-purple-light"><h2>电商管理系统</h2></div>
</el-col>
<el-col :span="1">
<div class="grid-content bg-purple"><a href="" class="loginout" @click.prevent="loginout()">退出</a></div>
</el-col>
</el-row>
</el-header>
<el-container>
<el-aside class="aslide" width="200px">
<el-menu
:router="true"
:unique-opened="true"
default-active="1"
...
<el-submenu index="3">
<template slot="title">
<span><i class="el-icon-location"></i>商品管理</span>
</template>
<el-menu-item index="3-1"><i class="el-icon-menu"></i>商品列表</el-menu-item>
<el-menu-item index="3-2"><i class="el-icon-menu"></i>分类列表</el-menu-item>
